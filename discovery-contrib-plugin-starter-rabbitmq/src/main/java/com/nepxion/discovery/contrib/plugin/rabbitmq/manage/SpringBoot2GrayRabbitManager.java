 ...
 * @author zhouzx
 */
public class SpringBoot2GrayRabbitManager implements ApplicationContextAware, RabbitManager {

    private static final Logger log = LoggerFactory.getLogger(SpringBoot2GrayRabbitManager.class);
    ...
    public SpringBoot2GrayRabbitManager(RabbitTemplate rabbitTemplate) {
    ...
    public void startListener(String queueName, int consumerNum, boolean ack, String msgListener) {
        ...
        ChannelAwareMessageListener listener = null;
        try {
            listener = applicationContext.getBean(msgListener, ChannelAwareMessageListener.class);
